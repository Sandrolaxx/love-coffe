...
import com.aktie.lovecoffee.data.model.Rule
import com.aktie.lovecoffee.data.model.mock.rulesMock
...
@Composable
fun LvCoffeeMarketDetailsRules(modifier: Modifier = Modifier, rules: List<Rule>) {
    Column(
        modifier = modifier,
...
@Preview
@Composable
private fun LvCoffeeMarketDetailsRulesPreview() {
    LvCoffeeMarketDetailsRules(

...
import com.aktie.lovecoffee.data.model.mock.categoriesMock

@Composable
fun LvCoffeeCategoryFilterChipList(
...
@Preview
@Composable
private fun LvCoffeeCategoryFilterChipListPreview() {
    LvCoffeeCategoryFilterChipList(
